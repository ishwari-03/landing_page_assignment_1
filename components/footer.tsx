            ...
            <div className="mx-auto max-w-5xl space-y-16 px-5 py-16">
                <div className="flex flex-wrap items-center justify-between gap-4 border-b pb-8">
                    <Link
                        href="/"
                        aria-label="go home">
                        <div className="text-3xl md:text-3xl font-medium bg-[linear-gradient(135deg,#0F172A_0%,#334155_50%,#1E293B_100%)] bg-clip-text text-transparent inline-block tracking-tight font-stretch-semi-condensed"><span>FocusFlow</span></div>
                    </Link>
                ...
                <div className="bg-muted mt-16 flex items-center justify-between rounded-md p-4 px-6 py-3">
                    <span>&copy; 2025 FocusFlow. All rights reserved.</span>
                    <Link
                        href="#"
                        className="text-muted-foreground hover:text-primary text-sm">
                        Designed to help you focus, not overwhelm you.
                    </Link>
                </div>
            </div>
        </footer>
